...
class Scoreboard():
    ...
    def __init__(self, ai_game):
        ...
        # Настройка шрифта для вывода подсчета
    ...
    def prep_level(self):
        ...
        level_str = ' '.join(['Уровень:', str(self.stats.level)])
        self.level_image = self.font.render(level_str, True, self.text_color, self.settings.bg_color)

        # Уровень выводится над текущим счетом
        self.level_rect = self.level_image.get_rect()
        self.level_rect.right = self.score_rect.right
        self.level_rect.top = self.score_rect.bottom + 10

    def prep_high_level(self):
        """Преобразует рекорд уровеня в графическое изображение"""
        high_level_str = ' '.join(['Реордный уровень:', str(self.stats.high_level)])
    ...
    def show_score(self):
        """Выводит на экран счет, рекорд, уровень и число кораблей"""
